...
import { faCopy, faEllipsisVertical, faPenToSquare } from '@fortawesome/free-solid-svg-icons';
...
const ProfileSetting = () => {
  ...
  return (
    <>
      <div className="container m-auto p-3 mb-5 text-gray-900 dark:text-white">
  ...
  return (
    <>
      ...
      <div className="my-5 grid grid-cols-12 gap-5">
        <div className="col-span-12 flex flex-col gap-4 sm:col-span-6 md:col-span-8 lg:col-span-8 xl:col-span-8 2xl:col-span-8 dark:text-white">
          {/* <label>
            Display name
          ...
          <label>
            Username
            <input type="text" defaultValue={profile?.username} onChange={(event) => handleChangeProfile(event, 'username')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="Enter your username" />
          </label>
          <label>
            Email
            <input type="text" defaultValue={profile?.email} onChange={(event) => handleChangeProfile(event, 'email')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="you@domain.com" />
          </label>
          <label>
            Your Bio
            <input type="text" defaultValue={profile?.bio} onChange={(event) => handleChangeProfile(event, 'bio')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="Tell about yourself" />
          </label>
          <div>
          ...
          <label>
            Your Website
            <input type="text" defaultValue={profile?.websiteUrl} onChange={(event) => handleChangeProfile(event, 'websiteUrl')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="https://domain.com" />
          </label>
          <label>
            Your Twitter
            <input type="text" defaultValue={profile?.twitterUrl} onChange={(event) => handleChangeProfile(event, 'twitterUrl')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="https://twitter.com/username" />
          </label>
          <label>
            Your Medium
            <input type="text" defaultValue={profile?.mediumUrl} onChange={(event) => handleChangeProfile(event, 'mediumUrl')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="https://medium.com/@username" />
          </label>
          <label>
            Your Telegram
            <input type="text" defaultValue={profile?.telegramUrl} onChange={(event) => handleChangeProfile(event, 'telegramUrl')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="https://t.me/username" />
          </label>
          <label>
            Your Discord
            <input type="text" defaultValue={profile?.discordUrl} onChange={(event) => handleChangeProfile(event, 'discordUrl')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="https://discordapp.com/users/username" />
          </label>
          <label>
            Your Instagram
            <input type="text" defaultValue={profile?.instagramUrl} onChange={(event) => handleChangeProfile(event, 'instagramUrl')} className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 focus:ring-primary-500" placeholder="https://instagram.com/username" />
          </label>
          <button className="mt-2 w-full rounded-full bg-primary-500 py-2 text-white hover:bg-primary-300" onClick={() => saveProfile()}>
            Save Setting
          </button>
        </div>
        <div className="col-span-12 flex h-fit flex-col gap-4 rounded-xl bg-white dark:bg-zinc-700 dark:text-white p-5 sm:col-span-6 md:col-span-4 lg:col-span-4 xl:col-span-4 2xl:col-span-4">
      ...
      <div className="col-span-12 flex flex-col gap-4">
        <div className="flex flex-col gap-3">
          ...
          <label>
            ...
            <input type="text" className="mt-2 w-full rounded-full border-0 bg-white dark:bg-zinc-700 dark:text-white focus:ring-primary-500" placeholder="Search any specific nft of yours" />
          </label>
    ...
    <div className="my-5 grid grid-cols-12 gap-5">
      <div className="col-span-12 flex flex-col gap-4">
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-12 gap-4 p-5 bg-white dark:bg-zinc-700 rounded-xl">
            <div className="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6 2xl:col-span-6 flex justify-between items-center bg-gray-100 dark:bg-zinc-600 p-5 rounded-3xl">
              <div className="w-fit gap-3 flex text-gray-600 dark:text-white">
                <Ethereum />
                <p>0x30756...Fb179</p>
