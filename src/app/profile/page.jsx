        ...
        <section>
          <div className="mt-5 flex justify-between">
            <div className="flex max-w-xs flex-col">
              ...
              <div className="mt-3 block h-[40px] overflow-hidden text-ellipsis text-lg  text-gray-900">
            ...
            <div className="flex flex-col">
              <div className="flex w-56 divide-x divide-gray-200 rounded-xl bg-white p-5 text-gray-900">
              ...
              <div className="mt-5 w-56 justify-between rounded-xl bg-white p-5 text-gray-900">
                <p>Address</p>
                <div>
          ...
          <div className="my-5 grid grid-cols-12 gap-6">
            <div className="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12 2xl:col-span-12">
              <div className="grid w-full grid-cols-12 gap-6 text-gray-900">
                <div className="col-span-6 mb-4 w-full sm:col-span-6 md:col-span-6 lg:col-span-3 xl:col-span-3 2xl:col-span-3">
                ...
                {collections.map((collection, index) => (
                  <div
                    key={index}
                    className="group col-span-6 h-[300px] w-full sm:col-span-6 md:col-span-6 lg:col-span-3 xl:col-span-3 2xl:col-span-3"
                  >
                    <img
                    ...
                    <div className="relative -top-5 inline-flex w-full flex-col items-center justify-center lg:items-start">
                      <div className="relative flex w-full flex-row px-5">
                        <div className="inline-flex w-full flex-col items-start justify-start rounded-bl-2xl rounded-br-2xl bg-gray-50 p-3 backdrop-blur-xl">
                          <div className="mt-4 flex w-full justify-between rounded-md bg-gray-100 px-2 py-2">
