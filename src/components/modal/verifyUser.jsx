                              ...
                              <div className="flex w-full items-center gap-3 rounded-full">
                                <div>
                                  <input
                                    ...
                                    value="creator"
                                    name="type"
                                    className="h-4 w-4 border-gray-300 bg-gray-100 text-red-600 focus:ring-2 focus:ring-red-500 dark:border-neutral-600 dark:bg-neutral-700 dark:ring-offset-neutral-800 dark:focus:ring-red-600"
                                    {...register('type', {
