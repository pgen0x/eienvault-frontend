      ...
      >
        {images.map((image, index) => (
          <SwiperSlide key={index}>
            <img className="w-[310px] rounded-2xl relative top-8 -left-4 z-10" src="https://via.placeholder.com/325x265" />
            <div className="w-[280px] inline-flex flex-col items-center justify-center lg:items-start">
              <div className="relative flex flex-row">
                <div className="my-3 w-[280px] inline-flex flex-col items-start justify-start gap-4 rounded-br-2xl rounded-bl-2xl bg-white p-5">
