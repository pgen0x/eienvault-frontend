...
export default function ModalRemoveWhitelistToken({
  isOpenModal,
  onClose,
  onModalClose,
}) {
    ...
    try {
      ...
      if (isAdmin) {
        if (selectedToken === zeroAddress) {
          toast.error('Please select ERC-20 token');
          setIsSubmit(false);
          return;
        }
        ...
        await walletClient.writeContract({
          ...
          functionName: 'removeWhitelistToken',
          args: [selectedToken],
          account: address,
        });
      } else {
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-zinc-800">
                  ...
                  >
                    Are you sure to remove the whitelisted token?
                  </Dialog.Title>
                          ...
                          <form>
                            <div className="w-full">
                              <div className="mt-2 w-full">
                                <p className="pt-2">
                                  Plase select token ERC-20 or HLUSD
                                </p>
                              </div>
