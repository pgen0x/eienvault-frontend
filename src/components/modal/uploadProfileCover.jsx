        ...
        <Dialog as="div" className="relative z-[80]" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle text-gray-950 shadow-xl transition-all dark:bg-neutral-900 dark:text-white">
                        ...
                        <div className="relative mt-2 flex flex-col items-center gap-3 border-2 border-dashed border-gray-200 bg-white py-3 text-center dark:bg-neutral-900">
                          {selectedImage && selectedImage.length > 0 ? (
                            ...
                            <>
                              ...
                              <label className="cursor-pointer rounded-full bg-primary-500 px-4 py-1 font-semibold text-white hover:bg-primary-300 dark:bg-neutral-500 dark:hover:bg-neutral-50">
                                Choose file
                                <input
                                  type="file"
                                  className="hidden"
